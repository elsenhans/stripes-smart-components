...
const CustomFieldsFilter = ({
  ...
  if (FilterComponent === DateRangeFilter) {
    return (
      <CustomFieldsDateRangeFilter
        ...
        name={filterName}
        onChange={onChange}
        showBasicAccordion={showBasicAccordion}
        onClearFilter={onClearFilter}
        filterNameBasic={filterNameBasic}
      />
    );
  }
  ...
  if (showBasicAccordion) {
    return (
      <Accordion
        displayClearButton
        id={`filter-accordion-custom-field-${refId}`}
      ...
      >
        <FilterComponent
          ...
          onChange={onChange}
          aria-labelledby={`filter-accordion-custom-field-${refId}`}
        />
      </Accordion>
    );
  }
